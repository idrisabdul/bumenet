<main id="main" class="main">
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <form method="post" enctype="multipart/form-data" action="<?= base_url('Admin/Product/insert_next_module') ?>">
          <div class="card">
            <div class="card-body mb-2">
              <h5 class="card-title">Next Module</h5>
            ...
            <div class="card-body">
              ...
              <div class="row mb-2">
                <div class="col-sm-7">
                  <p>Data Module yang sudah anda buat sebelumnya dari <code>Course</code> ini.</p>
                </div>
                <div class="col-sm-5">
                  <button type="button" id="add_module" class="btn btn-outline-primary"><i class="bi bi-plus me-1"></i>
                    Add Module</button>
                  <button type="button" id="save_and_publish" class="btn btn-primary"><i class="bi bi-plus me-1"></i>
                    Save & Publish</button>
                </div>
              </div>
              <!-- Small tables -->
              <table class="table table-sm">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Total Submodule</th>
            ...
            <div id="new_module" style="display: none" class="card-body">
              <div class="row mb-3">
                <div class="col-sm-10">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="submodule_name[]" id="submodule_name[]" class="form-control" required>
                </div>
              </div>
              <div class="row mb-5">
              ...
              <div class="row mb-3">
                <div class="col-sm-10">
                  ...
                  <button type="button" id="cancel_add_module" class="btn btn-warning">
                    Cancel</button>
        ...
        <!-- <div class="col-md-12 mb-4 text-center">
          <button type="submit" name="service_save_draft" id="save_and_publish" class="btn btn-primary">Save And
            Publish</button>
        </div> -->
      </div>
    </div>
