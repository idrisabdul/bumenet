                ...
                <div class="card">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($modules as $module) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('mentor/mentor/list_submodule/' . $module->module_course_id) ?>"
                                                id="edit_module" href="javascript:;" class="btn btn-xs btn-info"><i
                                                    class="bi bi-arrow-right-circle mr-1"></i></a>
                                            ...
                                            <button
                                                onclick="deleteConfirm('<?= base_url('mentor/mentor/delete_module/' . $module->module_course_id) ?>')"
                    ...
                    <div class="card-body">
                        ...
                        <?php foreach ($questions as $question) { ?>
                            ...
                            <button
                                onclick="deleteConfirm('<?= base_url('mentor/mentor/delete_question/' . $question->question_id) ?>')"
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('mentor/mentor/insert_module') ?>" method="POST">
...
<div class="modal fade" id="addQuiz" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('mentor/mentor/insert_quiz') ?>" method="POST">
                <div class="modal-body">
                    <div class="row clearfix mb-3">
                        <div class="col-sm-12">
...
<div class="modal fade" id="edit_question" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('mentor/mentor/update_question') ?>" method="POST">
                <div class="modal-body">
                    <div class="row clearfix mb-3">
                        <div class="col-sm-12">
                            <label for="">Question</label>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('mentor/mentor/update_module') ?>" method="POST">
                <div class="modal-body">
                    <div class="row clearfix mb-3">
                        <div class="col-sm-12">
                            <label for="">Module Name</label>
...
<div class="modal fade" id="editcourse" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('mentor/mentor/update_course') ?>" method="POST" id="identifier">
                <div class="modal-body">
                    <div class="row clearfix mb-3">
                        <div class="col-sm-12">
...
<div class="modal fade" id="edit_answer" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('mentor/mentor/update_answer') ?>" method="POST">
                <div class="modal-body">
                    <div class="row clearfix mb-3">
                        <div class="col-sm-12">
