	...
	<section class="section">
		<div class="row">
			<div class="col-xl-3">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Donasi | <span>Saweria a/n <a target="_blank" href="https://saweria.co/bumenetcom">bumenetcom</a> </span></h5>
						<img src="<?= base_url() ?>images/donasi.png" class="card-img-top px-5" alt="...">
						<!-- <a href="https://saweria.co/bumenetcom" class="text-center">donasi</a> -->
					</div>
				</div>
				<div class="card">
					<div class="card-body">
			...
			<div class="col-xl-9">
				...
				<div class="card mb-3">
					<div class="card-body">
						<h5 class="card-title">Sharing Everything <span>| Topik yang mungkin menarik</span><a
								href="<?= base_url("sharing") ?>" id="btn-done"
								class="card-link btn btn-sm btn-outline-primary d-flex float-end">Lihat lebih banyak<i
